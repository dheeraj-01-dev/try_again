  ...
  return (
      <div style={style} className={styles.profileSection}>
        <div style={{display: "flex"}}>
          <div>
            <Image className={styles.profilePic} width={60} height={60} alt='' src="/temp-profile.png" />
            <div className={styles.exp}>Exp. 78</div>
          </div>
          <div className={styles.infoContainer}>
            <div>
              <div className={styles.name}>{"UN_DEFE4TED"}</div>
              <div className={styles.uid}>{uid}</div>
            </div>
            <div className={styles.socialMedia}>
              <div className={styles.youtube}>
                <Image height={13} width={13} alt='wise' src="/icons/image-.png" /> &nbsp;&nbsp;
                <Image height={13} width={13} alt='newier' src="/icons/image-.png" /> &nbsp;&nbsp;
                <Image height={13} width={13} alt='lucky' src="/icons/image-.png" /> 
              </div>
            </div>
          </div>
        </div>
